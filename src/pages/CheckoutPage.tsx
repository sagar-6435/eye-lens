  ...
  if (isSuccess) {
    return (
      <div className="container mx-auto px-4 py-32 text-center">
        ...
        >
          <div className="w-24 h-24 bg-green-900/30 text-green-400 rounded-full flex items-center justify-center mx-auto mb-8">
          ...
          <div className="bg-muted p-6 rounded-3xl mb-12 inline-block text-left w-full">
             ...
             <div className="flex justify-between items-center">
               ...
               <span className="bg-green-900/30 text-green-400 px-3 py-1 rounded-full text-xs font-bold uppercase">Processing</span>
             </div>
          </div>
    ...
    <div className="container mx-auto px-4 md:px-6 py-12">
      <div className="flex flex-col lg:flex-row gap-16">
             ...
             {[
               ...
               <React.Fragment key={s.n}>
                 <div className="flex items-center gap-3 shrink-0">
                    <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold transition-all ${step >= s.n ? 'bg-accent text-secondary' : 'bg-muted text-muted-foreground'}`}>
                      {s.n}
                    </div>
                    <span className={`text-sm font-bold uppercase tracking-wider ${step >= s.n ? 'text-primary' : 'text-muted-foreground'}`}>{s.label}</span>
                 </div>
                 {s.n < 3 && <div className={`w-12 h-[2px] shrink-0 ${step > s.n ? 'bg-accent' : 'bg-muted'}`} />}
               </React.Fragment>
             ))}
          </div>
          ...
          <AnimatePresence mode="wait">
                ...
                <div>
                   ...
                   <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                      <div className="space-y-2">
                        ...
                        <input type="text" placeholder="John Doe" className="w-full px-6 py-4 bg-muted border border-border rounded-2xl outline-none focus:border-accent transition-all text-primary placeholder:text-muted-foreground" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Phone Number</label>
                        <input type="tel" placeholder="+91 98765-43210" className="w-full px-6 py-4 bg-muted border border-border rounded-2xl outline-none focus:border-accent transition-all text-primary placeholder:text-muted-foreground" />
                      </div>
                      <div className="md:col-span-2 space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Street Address</label>
                        <input type="text" placeholder="House no, Street name" className="w-full px-6 py-4 bg-muted border border-border rounded-2xl outline-none focus:border-accent transition-all text-primary placeholder:text-muted-foreground" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">City</label>
                        <input type="text" placeholder="New Delhi" className="w-full px-6 py-4 bg-muted border border-border rounded-2xl outline-none focus:border-accent transition-all text-primary placeholder:text-muted-foreground" />
                      </div>
                      <div className="space-y-2">
                        <label className="text-xs font-bold uppercase tracking-widest text-muted-foreground ml-1">Pincode</label>
                        <input type="text" placeholder="110001" className="w-full px-6 py-4 bg-muted border border-border rounded-2xl outline-none focus:border-accent transition-all text-primary placeholder:text-muted-foreground" />
                      </div>
                   </div>
                </div>
                ...
                <div className="p-6 bg-muted rounded-[2rem] border border-border">
                   <div className="flex gap-4">
                      ...
                      <div>
                        ...
                        <p className="text-xs font-bold text-green-400 mt-1 uppercase tracking-wider">Free Shipping Applied</p>
                      </div>
                   </div>
                </div>
            ...
            {step === 2 && (
              ...
              >
                   ...
                   <div className="grid grid-cols-1 gap-4">
                      {[
                        ...
                        <button 
                          ...
                          className={`p-6 rounded-3xl text-left border-2 transition-all flex items-center gap-6 ${paymentMethod === method.id ? 'border-accent bg-accent/10' : 'border-border hover:border-border/70 bg-muted'}`}
                        >
                           <div className={`w-14 h-14 rounded-2xl flex items-center justify-center ${paymentMethod === method.id ? 'bg-accent text-secondary' : 'bg-secondary text-muted-foreground'}`}>
                              {method.icon}
                           </div>
                           ...
                           <div className={`w-6 h-6 rounded-full border-2 flex items-center justify-center ${paymentMethod === method.id ? 'border-accent bg-secondary' : 'border-border'}`}>
                              {paymentMethod === method.id && <div className="w-3 h-3 bg-accent rounded-full" />}
                           </div>
                        </button>
                      ))}
                   </div>
                ...
                {paymentMethod === 'card' && (
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6 p-8 border border-border rounded-[2.5rem] bg-muted">
                    <div className="md:col-span-2 space-y-2">
                       <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Card Number</label>
                       <input type="text" placeholder="0000 0000 0000 0000" className="w-full px-5 py-3 border border-border rounded-xl outline-none focus:border-accent bg-secondary text-primary placeholder:text-muted-foreground" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">Expiry Date</label>
                       <input type="text" placeholder="MM/YY" className="w-full px-5 py-3 border border-border rounded-xl outline-none focus:border-accent bg-secondary text-primary placeholder:text-muted-foreground" />
                    </div>
                    <div className="space-y-2">
                       <label className="text-[10px] font-bold uppercase tracking-widest text-muted-foreground ml-1">CVV</label>
                       <input type="password" placeholder="***" className="w-full px-5 py-3 border border-border rounded-xl outline-none focus:border-accent bg-secondary text-primary placeholder:text-muted-foreground" />
                    </div>
                  </div>
                )}
                      ...
                      <div className="space-y-4 max-h-64 overflow-y-auto pr-4 no-scrollbar">
                         {items.map((item) => (
                           <div key={item.id} className="flex gap-4 items-center">
                              <div className="w-16 h-16 bg-secondary rounded-xl p-1">
        ...
        <div className="flex-1">
          <div className="sticky top-32 bg-muted p-8 rounded-[2.5rem] border border-border shadow-premium">
